                ...
                >
                  ...
                  >
                    {!!selected.find((p: any) => p.id === media.id) ? (
                      <div className="text-white flex z-[101] justify-center items-center text-[14px] font-[500] w-[24px] h-[24px] rounded-full bg-[#c15f3c] absolute -bottom-[10px] -end-[10px]">
          ...
          <div className="flex justify-end mt-[32px] gap-[8px]">
            ...
            {!isLoading && !!data?.results?.length && (
              <button
                ...
                className="cursor-pointer text-white disabled:opacity-80 disabled:cursor-not-allowed h-[52px] px-[20px] items-center justify-center bg-[#c15f3c] flex rounded-[10px]"
              >
